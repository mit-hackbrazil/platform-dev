...
var resolver = {
  ...
  Mutation: {
    ...
    addTeam: function () {
      ...
      return function addTeam(_x7, _x8, _x9) {
...
function () {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee6(key_name) {
    var table_name,
        keyIsUsed,
        new_key,
        findKey,
    ...
    return _regenerator.default.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            table_name = _args6.length > 1 && _args6[1] !== undefined ? _args6[1] : "teams";
            keyIsUsed = true;
          ...
          case 6:
            findKey = _context6.sent;
            keyIsUsed = findKey.length > 0 ? true : false;
            _context6.next = 2;
            break;

          case 10:
            return _context6.abrupt("return", new_key);
  ...
  return function GenerateKey(_x13) {
    return _ref3.apply(this, arguments);
  };
}();

function ValidateEditKey(_x14, _x15) {
...
function _ValidateEditKey() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee7(id, edit_key) {
    var result;
...
function ValidateViewKey(_x16, _x17) {
...
function _ValidateViewKey() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee8(id, view_key) {
    var result;
